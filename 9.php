...
<section class="deals-on-product">
		<section class="order-status-filter">
			...
			<div class="m-10">
				<button class="btn product-btn"><a href="#">Request For New Proudct</a>
			</div>
			</div>
				<hr class="line">
						...
						<div class="cateloue-table">
									<table id="t01">
									  ...
									  <tr>
									    ...
									    <td>Food</td>
									    <td>$100</td>
									    <td><div class="quantity-col-2 "><div class="quantity buttons_added product-info text-center">
									<input type="button" value="-" class="minus"><input type="number" step="1" min="1" max="" name="quantity" value="1" title="Qty" class="input-text qty text" size="4" pattern="" inputmode="" id="quantity"><input type="button" value="+" class="plus">
									    ...
									    <button class="btn m10"><a href="#">View</a>
									    </button>
									    <button class="btn m-10"><a href="#">Watch-list</a>
									    </button>
									    <button class="btn m-10"><a href="#">Remove</a>
									    </button>										
										</div>
										</td>								   
									  </tr>
								...
								<div class="jcenter center text-center"><button class="btn m-10"><a href="#">Continue Shopping </a></button></div>
							</div>
						</div>
					</div>
		</section>
