				    ...
				    <a href="#"><i class="fas fa-search search-icon"></i></a>
						...
						<div class="product-details-inner">
							...
							<div class="product-info">
								...
								<div class="checkout">
								<h3 class="price" data-price="400">Max Value : $400</h3>
								<div class="quantity-flex">	
								<div class="quantity-col-1"><h3>Quantity : </h3></div> <div class="quantity-col-2"><div class="quantity buttons_added product-info">
								...
								</div><h3  class="total">Total Max Value : <span id="total">$400</span> </h3>	
